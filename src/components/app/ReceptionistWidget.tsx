  ...
  const startCall = useCallback(async () => {
    ...
    try {
      ...
      const sessionPrompt = [
        ...
        "- Live data: calls, leads (from tagged calls), business info / phone numbers.",
        "- NOT yet connected (demo content only): SMS messages, reviews, calendar/appointments, notifications feed, notes list. If the user asks about these, say honestly that they aren't wired to live data yet, offer to navigate them there, and offer related calls/leads info instead.",
