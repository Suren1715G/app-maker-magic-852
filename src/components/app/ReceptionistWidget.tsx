  ...
  const startCall = useCallback(async () => {
    ...
    try {
      ...
      const sessionPrompt = [
        ...
        "",
        "## Tools you have",
        "- lookup_business_data: ALWAYS use this for any question about the user's calls, leads, customers, missed calls, recent activity, phone numbers, or business info. Actions: business_info, call_stats (period: today/week/month), recent_calls (limit), search_calls (query), leads_summary (period). Never invent numbers — always call this tool first.",
        ...
        "",
        "## Rules",
        "- For ANY question about call counts, recent calls, leads, or business data — call lookup_business_data FIRST. Do not say 'I can't help' or 'I don't have that info' without trying the tool.",
